...
import edu.uph.duasatusi.edbertapp.Adapter.ProdukAdapter;
import edu.uph.duasatusi.edbertapp.Model.Produk;
...
//        produkArrayList.add(produk8);
    ...
    public void initRealm(){
        ...
        simpanDataProduk("Pocari Sweat 500 ml", 9000, R.drawable.pocari);

        simpanDataProduk("Indomi Ayam Bawang 69g", 3100, R.drawable.indomie);
